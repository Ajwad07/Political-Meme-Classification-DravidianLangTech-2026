...
## Repository Contents
* `Gated_CrossModal_Hierarchical_XLSX.ipynb`: The main Jupyter Notebook containing the data loading, model architecture, training loop, and evaluation pipeline.
